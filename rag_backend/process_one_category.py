...
def main():
    parser = argparse.ArgumentParser(description='Process documents for a specific category.')
    parser.add_argument('category', help='Category name to process')
    ...
    if success:
        print(f"\n✅ Successfully processed {category} documents")
    else:
        print(f"\n❌ Failed to process {category} documents")
